...
public class LecUtils {
	...
	public LecUtils(ApplicationContext applicationContext, ObjectMapper objectMapper) {
	 ...
	 */
	@SuppressWarnings("unchecked")
	public static <T> T applyPatch(T originalObj, String patchString) throws IOException, JsonPatchException {
